...
$moz_packages = ['createrepo', 'nginx', 'gunicorn', 'logstash', 'python26', 'python26-setuptools', 'rubygem-petef-statsd', 'zeromq', 'python-devel', 'rpm-devel', 'rpm-python', 'rpmdevtools']
